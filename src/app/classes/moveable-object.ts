...
export abstract class MoveableObject {
   ...
   *
   * @param height - the height of the moveable object, in pixels
   * @param width - the width of the moveable object, in pixels
   * @param maxSpeed - the max distance, in pixels, the object can move
   ...
   *
   * @param xratio - the percentage of maxSpeed to move in x direction
   * @param yratio - the percentage of maxSpeed to move in y direction
   */
